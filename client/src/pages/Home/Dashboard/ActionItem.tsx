...
function ActionItem({ icon, title, subtitle, onClick }: ActionItemProps) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="action-item translate-y-6 opacity-0 flex items-center space-x-3 min-w-xs max-w-md shadow border border-gray-300 rounded-2xl bg-white px-2 py-2 w-full overflow-hidden cursor-pointer"
    >
